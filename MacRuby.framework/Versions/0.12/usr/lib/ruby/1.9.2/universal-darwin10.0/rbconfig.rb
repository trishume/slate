...
module RbConfig
  ...
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Library/Frameworks/MacRuby.framework/Versions/0.12/usr")
  CONFIG["INSTALL_VERSION"] = "0.12"
  CONFIG["EXEEXT"] = ""
  ...
  CONFIG["OBJEXT"] = "o"
  if File.exist? "/usr/bin/g++-4.2"
    CONFIG["CXX"] = "/usr/bin/g++-4.2"
  else
  ...
  CONFIG["LIBRUBY_ALIASES"] = "libmacruby.1.9.dylib libmacruby.dylib"
